...
class TestURLsCategories(TransactionTestCase):
    ...
    def test_category(self):
        ...
        self.assertTemplateUsed(response, template_name='category/category.html')
    ...
    def test_category_not_found(self):
        ...
        self.assertTemplateUsed(response, template_name='category/exceptions/category_not_found.html')
